...
function(b, f) {
    ...
    b.jPlayer.prototype = {
        ...
        _updateVolume: function(a) {
        	...
        	$(".time_dian_v").css("margin-left",(100*a+"%"));
        ...
        _updateAutohide: function() {
            ...
            this.css.jq.gui.length && (this.css.jq.gui.stop(!0, !0), clearTimeout(this.internal.autohideId), this.element.unbind(".jPlayerAutohide"), this.css.jq.gui.unbind(".jPlayerAutohide"), this.status.nativeVideoControls ? this.css.jq.gui.hide() : 1 && this.options.autohide.full || 0 && this.options.autohide.restored ? (this.element.bind("mousemove.jPlayer.jPlayerAutohide", c), this.css.jq.gui.bind("mousemove.jPlayer.jPlayerAutohide", c), this.css.jq.gui.hide()) : this.css.jq.gui.show())
        },
        fullScreen: function() {
        	$("#name_h3_2").addClass("title_h3");
        	$("#name_h3_2").show();
        	$("#jquery_jplayer_1").css("marginTop","0");
            this._setOption("fullScreen", !0)
        },
        restoreScreen: function() {
        	$("#name_h3_2").removeClass("title_h3");
        	$("#name_h3_2").hide();
        	$("#jquery_jplayer_1").css("marginTop","50px");
        ...
        _fullscreenchange: function() {
            this.options.fullScreen && !b.jPlayer.nativeFeatures.fullscreen.api.fullscreenElement() && this._setOption("fullScreen", !1) && this.restoreScreen()
        },
