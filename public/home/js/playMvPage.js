...
var playMvPage = {
     ...
     * */
    getMvlike: function () {
        // http://www.kugou.com/mvweb/app/index.php?m=Index&a=likemvs&mv=4183145&id=145080
        $.ajax({
            type: "GET",
            dataType: "json",
            url: "http://www.kugou.com/mvweb/app/index.php?m=Index&a=likemvs&mv=" + mv_audio_id + "$id=" + mv_id,
    ...
    share: function (data) {
        var _this = this,
            ...
            sharePic = mv_pic || "http://www.kugou.com/yy/static/images/share-cover.png";
    ...
    init: function () {
        ...
        if (_this.isIE(8)) {
            $('.qrcodeForMobile').qrcode({ render: "table", width: 120, height: 120, text: "http://m.kugou.com/mv/" + mv_id + ".html" + hrefStr });
        } else {
        ...
        $(".shareBtn").on("click", function (e) {
            ...
            var shareData = {
                FileName: mv_name,
                url: "http://www.kugou.com/mvweb/html/mv_" + mv_id + ".html",
                Hash: mv_hash
            }
