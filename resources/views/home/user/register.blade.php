            ...
            <div class="kg_lgn_reg_box" id="regBox">
                ...
                <div class="kg_lgn_reg_ct" id="regCntList">
                    ...
                    <div class="kg_lgn_reg_ct_item" >
                        <form id="t01Form" action="/home/doreg" method="post">
                            <table class="kg_lgn_reg_tb" width="100%">
                                ...
                                <tr>
                                    <td align="right" valign="top"><label for="t01Unm2" class="kg_lgn_reg_tb_tl"><span class="red">*</span> 昵称：</label></td>
                                    <td>
                                        <div class="kg_lgn_textbox_area kg_lgn_textbox_repassword">
                                            <div class="kg_lgn_textbox"><input maxlength="16" id="t01Unm2" name="uname" type="text" class="kg_lgn_textbox_ipt" /></div>
                                            <div class="kg_lgn_tips"><i class="kg_lgn_tips_icon"></i><span class="kg_lgn_tips_txt"></span></div>
                                        </div>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td align="right" valign="top"><label for="t01Psw2" class="kg_lgn_reg_tb_tl"><span class="red">*</span> 确认密码：</label></td>
                                    <td>
                                        <div class="kg_lgn_textbox_area kg_lgn_textbox_repassword">
                                            <div class="kg_lgn_textbox"><input maxlength="16" id="t01Psw2" name="repassword" type="password" class="kg_lgn_textbox_ipt" /></div>
                                            <div class="kg_lgn_tips"><i class="kg_lgn_tips_icon"></i><span class="kg_lgn_tips_txt"></span></div>
                                        </div>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td width="300" align="right" valign="top"><label for="t01Email" class="kg_lgn_reg_tb_tl"><span class="red">*</span> 邮箱：</label></td>
                                    <td>
                                        <div class="kg_lgn_textbox_area kg_lgn_textbox_email">
                                            <div class="kg_lgn_textbox"><input id="t01Email" maxlength="30" name="email" type="text" class="kg_lgn_textbox_ipt" /></div>
                                            <div class="kg_lgn_tips"><i class="kg_lgn_tips_icon"></i><span class="kg_lgn_tips_txt"></span></div>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <span class="pcr_iptbox pcr_codebox">
                                            ...
                                            <!-- <a id="emailt01CodeChange"  class="kg_lgn_changeone"><img src="">换一张</a> -->
                                        </span>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td></td>
                                    <td>
                                        <span class="reg_btn_s01" id="t01Submit"><input type="submit" name="" value="注册"  /></span>
                                        {{csrf_field()}}
